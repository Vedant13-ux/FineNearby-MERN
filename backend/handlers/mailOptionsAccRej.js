...
function mailOptions(req, process) {
  return ({
    ...
    to: req.body.sharedBy,
    subject: `Find Nearby - ${req.body.name} Service Sharing`,
    text: `
            Credentials`,
    html: `
            ...
            <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="backgroundTable" style="height:100% ;margin:0;padding:0;width:100% ;background-color:#FAFAFA;">
              <tr>
                <td align="center" valign="top" style="border-collapse:collapse;">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateContainer" style="border:1px none #DDDDDD;background-color:black;">
                    <tr>
                      <td align="center" valign="top" style="border-collapse:collapse;">
                        <!-- // Begin Template Header \\ -->
                        <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateHeader" style="background-color: black ;border-bottom:0;">
                          <center>
                            <tr>
                              <td class="headerContent centeredWithBackground" style="text-align: center! important; color:white !important;border-collapse:collapse;color: black;font-family:Arial;font-size:34px;font-weight:bold;line-height:100%;padding:0;text-align:center;vertical-align:middle;background-color:black;padding-bottom:20px;padding-top:20px; border-top-left-radius:30px; border-top-right-radius:30px">
                                  <center><img
                                      src='https://res.cloudinary.com/ved13/image/upload/v1651747178/logo_phdnkq_1_d0jjfl.png'
                                ...
                                <tr>
                                  <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                    <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                      <h1 class="h1" style="color:#202020;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Hey ${req.body.name.split(' ')[0]}</h1>
        
                                      <!-- <h2 class="h2">Heading 2</h2>
                                                                        <h3 class="h3">Heading 3</h3>
                                                                        <h4 class="h4">Heading 4</h4> -->
                                      <p>${req.body.owner_name} wants to share the ${req.body.service_name} service with you, scheduled at ${req.body.time}, on ${req.body.date}.</p>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                      ...
                                      <tbody>
                                        <tr align="center">
                                          <td align="center" valign="middle" style="border-collapse:collapse;">
                                            <a href="http://localhost:3000/myservices" class="buttonText" href="#" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">
                                               Accept or Reject
                                            </a>
                                          </td>
                                        </tr>
