...
function mailOptions(req, process) {
  return ({
    ...
    to: req.body.email,
    subject: 'Find Nearby - Credentials',
    text: `
          Credentials`,
    html: `
                            ...
                            <tr>
                              <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                                <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                                  ...
                                  <p>Use the following credentials to Sign in into your Find Nearby account to seamlessly book the hotel services. We hope you enjoy your stay!</p>
                                </div>
                              </td>
                            </tr>
                            <tr>
                                  ...
                                  <tbody>
                                    <tr align="center">
                                      <td align="center" valign="middle" style="border-collapse:collapse;">
                                        <a href="http://localhost:3000" class="buttonText" href="#" target="_blank" style="color: #4A90E2;text-decoration: none;font-weight: normal;display: block;border: 2px solid #585858;padding: 10px 80px;font-family: Arial;">
